...
%---------------------------------------------------------
  \cventry
    ...
    {Mar. 2020 - Present} % Date(s)
    {
      ...
      \item {Built the user interface. Visit the business at \MYhref{https://artif.ai}{https://artif.ai}. To date there have been over \textbf{2500} artifaications (React, Webflow).}
      \end{cvitems}
    }
